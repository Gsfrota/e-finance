...
BEGIN
  ...
  ELSIF p_defer_action = 'last' THEN
    -- Encontrar última parcela pendente (diferente desta)
    ...
    ELSE
      -- Fallback para 'new' se não houver parcela alvo
      p_defer_action := 'new';
    END IF;
  END IF;
  ...
  IF p_defer_action = 'new' THEN
    ...
    -- Atualizar total_installments no contrato
