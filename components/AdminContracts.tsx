                            ...
                            {formData.calculation_mode === 'manual' && (
                                <div className="space-y-2 animate-fade-in">
                                    ...
                                    <div className="text-center text-xs text-[color:var(--text-secondary)]">
                                        Taxa Implícita:{' '}
                                        {formData.interest_rate === 0
                                            ? <span className="text-amber-600 dark:text-amber-400 font-bold">0,00% ⚠️ sem juros</span>
                                            : <strong className="text-[color:var(--text-primary)]">{(Number(formData.interest_rate) || 0).toFixed(2)}%</strong>
                                        }
                                    </div>
                                </div>
                            )}
