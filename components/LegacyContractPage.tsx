...
const inputCls = "w-full min-w-0 bg-[color:var(--bg-base)] border border-[color:var(--border-subtle)] rounded-xl px-3 py-2 text-[color:var(--text-primary)] text-sm focus:border-teal-500 outline-none transition-all";
