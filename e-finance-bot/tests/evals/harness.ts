...
const mocks = vi.hoisted(() => ({
  ...
  getOpenInstallmentsByDebtorName: vi.fn(),
...
vi.mock('../../src/actions/admin-actions', () => ({
  ...
  getOpenInstallmentsByDebtorName: mocks.getOpenInstallmentsByDebtorName,
...
function applyDefaults(state: AgentEvalHarnessState) {
  ...
  mocks.getOpenInstallmentsByDebtorName.mockResolvedValue({ installments: [], matchedDebtors: 0 });
