/**
 * Gerador de payload PIX (BR Code), padrão EMVCo.
 *
 * Portado de `services/pix.ts` do app principal (E-Finance) para manter
 * paridade do copia-e-cola entre web e bot. A chave PIX entra como string
 * no campo `01` — funciona para CPF, CNPJ, e-mail, telefone ou EVP.
 */

// Faixa de marcas diacríticas combinantes (acentos) — removidas na normalização.
